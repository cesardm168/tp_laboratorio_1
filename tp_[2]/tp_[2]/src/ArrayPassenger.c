...
int  addPassenger(ePassenger* pasajeros, int tam, int id, char name[], char lastName[], float price, int typePassenger, char flycode[], int* pNextId, int statusFlight)
{
    ...
    if(pasajeros!=NULL && tam>0 && pNextId!=NULL)
    {
        if(searchFree(pasajeros, tam, &indice))
        {
            ...
            {
                utn_getString("Ingrese Nombre: ", "Error. Ingrese Nombre valido. ", 51, 5, name);

                utn_getString("Ingrese Apellido: ", "Error. Ingrese Apellido valido. ", 51, 5, pasajeros[indice].lastName);

                utn_getFloat("Ingrese precio del vuelo: ", "Error. Ingrese un precio valido. ", 1, 30000000, 5, &price);
                ...
                utn_getInt("Ingrese Tipo de Pasajero: ", "Error. Ingrese un Tipo de Pasajero valido.",1,3,5, &typePassenger);
                ...
                utn_getInt("Ingrese Estado del Vuelo: ", "Error. Ingrese un Estado de Vuelo valido.",1,3,5, &statusFlight);
...
int menu(){
    ...
    printf("| 3- BAJA                                        |\n");
    printf("| 4- INFORMES                                    |\n");
    printf("| 5- HARCODEAR PASAJEROS                         |\n");
    printf("| 6- SALIR                                       |\n");
    printf("|                                                |\n");
    printf("|________________________________________________|\n");

    utn_getInt("Elija una opcion: ", "Error, Ingrese una opcion valida!!", 1, 6, 20, &opcion);
...
int hardcodearPassenger(ePassenger vec[], int tam, int cant, int* pId)
{
    ...
    {
        {0, "Juan", "Martinez",  100000,"AABBC12345",1,3,0},
        {0, "Daniela", "Flores",  120000,"CBDAR45678",2,2,0},
        {0, "Lucia", "Lopez",  140000,"QDXRZ98765",3,1,0},
        {0, "Mauro", "Viale",  232000,"PWRTA65432",1,1,0},
        {0, "Diego", "Maradona",  12000,"LMAOS45632",2,3,0},
        {0, "Juana", "Ruiz",  130000,"SSRRM00563",3,2,0},
        {0, "Miguel", "Rodriguez",  120000,"TRATA14569",2,1,0},
        {0, "Luciano", "Heredia", 150000,"BBMWN65987",1,1,0},
        {0, "Marina","Hermes",  120000,"SARAS00335",1,3,0 },
        {0, "Dalma", "Zapata",  110000,"AADDS11223",3,2,0}
    };
